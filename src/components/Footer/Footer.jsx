      ...
      <div className="container mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center space-x-4 mt-6">
          {[
            ...
            { icon: <FaLinkedin />, link: "https://www.linkedin.com/in/mohd-aman-ab9608294/" },
            { icon: <FaInstagram />, link: "https://www.instagram.com/mohd_aman_sheikh_/" },
            { icon: <FaGithub />, link: "https://github.com/MR-AMAN123" },
