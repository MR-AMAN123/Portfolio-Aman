...
const Experience = () => {
  return (
    <section
      id="experience"
  className="py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[16vw] font-sans bg-transparent clip-path-custom-2"
    >
      {/* Section Title */}
      ...
      <div className="relative">
        ...
        {experiences.map((experience, index) => (
          ...
          >
            ...
            {/* Content Section */}
            <div
              className={`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl shadow-2xl border border-gray-200 dark:border-white bg-white dark:bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] ${
              ...
              <div className="mt-4">
                ...
                <ul className="flex flex-wrap mt-2">
                  {experience.skills.map((skill, index) => (
                    <li
                      key={index}
                      className="bg-[#8245ec] text-gray-100 dark:text-gray-300 px-4 py-1 text-xs sm:text-sm rounded-lg mr-2 mb-2 border border-gray-400"
                    >
                      {skill}
                    </li>
                  ))}
