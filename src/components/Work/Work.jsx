      ...
      <div className="grid gap-12 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {projects.map((project, index) => (
          <motion.div
            ...
            className="border border-white bg-gray-900/80 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden cursor-pointer hover:shadow-purple-500/50 transition-transform duration-300"
          >
            <div className="p-4">
              <img
                src={project.image}
